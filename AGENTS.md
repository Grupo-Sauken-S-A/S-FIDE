...
8. **Los jars de distribución nunca llevan versión en el nombre** (`XMLSignerPKCS11.jar`, no `XMLSignerPKCS11-1.1.0.jar`) — ver sección 4. Los artefactos crudos de Maven en `target/` sí la llevan, eso es normal y no se debe "corregir".
