...
public class XMLSignerPKCS11 {
    private static final String VERSION = "S-FIDE XMLSignerPKCS11 v1.2.0 - Grupo Sauken S.A.";
    ...
    /**
     * Detecta si el documento es un XML de comercio exterior ALADI/MERCOSUR
     * (Certificado de Origen Digital o Declaración Jurada de Origen), buscando
     * un elemento con Id/id/ID igual a "COD" o "DJO" en cualquier parte del
     * documento. Devuelve "COD", "DJO", o null si no es ninguno de los dos
     * (XML estándar).
     */
