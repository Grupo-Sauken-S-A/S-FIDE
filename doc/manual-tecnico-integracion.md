...
- **Ventana de Ayuda, pestaña "Documentación":** enlaces para abrir, en el navegador web predeterminado del sistema, los documentos HTML de `doc/` (Guía de Usuario y Manual Técnico) como URL `file://`. La pestaña "Contacto" de la misma ventana incluye además un enlace a la página del proyecto en GitHub.
